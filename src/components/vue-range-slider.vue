<template>
  <div 
   class="ui-slider" tabindex="0" v-el:slider
   ...
   @mousedown="sliderClick" @keydown.left.prevent="decrement" @keydown.right.prevent="increment">
    ...
    <div class="ui-slider-containment" v-el:container></div>
  ...
  export default {
    ...
    ready () {
      ...
      this.draggable = new Draggabilly(this.$els.thumb, {
        containment: this.$els.container,
        axis: 'x'
      })
...
<style lang="stylus" scoped>
  ...
  // Track line
  $track-height = 3px;
  $track-background-color = alpha(black, 0.28);
